...
class MVSDataset(Dataset):
    ...
    def tr_read_cam(self, file, ndepths, interval_scale=1):
    ...
    def read_depth(self, filename):
        ...
        depth_image = (np.float32(depimg) / 64.0)
    ...
    def __getitem__(self, idx):
        ...
        for view in range(self.view_num):
            ...
            # Cameras
            cam, location = self.tr_read_cam(data[2 * view + 1], self.ndepths, self.interval_scale)
